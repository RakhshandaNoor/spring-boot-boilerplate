...
QuizCardComponent.ctorParameters = () => [
...
let QuizPlayComponent = class QuizPlayComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let QuizetencyService = class QuizetencyService {
    constructor(http) {
        this.http = http;
...
QuizetencyService.ctorParameters = () => [
